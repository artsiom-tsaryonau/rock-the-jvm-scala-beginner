...
object TuplesAndMaps extends App {
  ...
  println(aTuple.swap) // swaps the elements in place ("hello, Scala", 2)
  ...
  // filter keys
  println(phoneBook.filterKeys(x => x.startsWith("J"))) // deprecated, uses view
  // map values
  println(phoneBook.mapValues(number => number * 10)) // deprecated, uses view
  ...
  /*
    ...
    2. voerly simplified social network based on maps
